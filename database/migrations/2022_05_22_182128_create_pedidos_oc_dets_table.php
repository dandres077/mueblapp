...
class CreatePedidosOcDetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pedidos_oc_dets', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('empresa_id')->index()->nullable();
            $table->unsignedBigInteger('producto_id')->index()->nullable();
            $table->unsignedBigInteger('pedido_oc_id')->index()->nullable();
            ...
            $table->foreign('pedido_oc_id')->references('id')->on('pedidos_ocs')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('pedidos_oc_dets');
    }
}
