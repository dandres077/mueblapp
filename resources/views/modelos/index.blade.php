        ...
        <div class="kt-portlet__body">
            ...
            <!--begin: Datatable -->
             <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                <tbody>
                @foreach ($data as $modelos)
                <tr class="gradeX">
                    <td>{{$modelos->id}}</td>
                    <td>{{$modelos->nom_marca}}</td>
                    <td>{{$modelos->nombre}}</td>
                    <td>{{$modelos->estado_elemento}}</td>
                    <td>   
                        <div class="dropdown dropdown-inline">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="{{ url('admin/modelos/'.$modelos->id.'/edit')}}"><i class="la la-edit"></i>Editar</a>                              
                                <form method="post" action="{{ url('admin/modelos/'.$modelos->id)}}" class="formulario-eliminar">
                                    @method('DELETE')
                                    {{ csrf_field() }}
                                ...
                                @if ($modelos->status==1)
                                    ...
                                    <form method="post" action="{{ url('admin/modelos/'.$modelos->id.'/inactive')}}">
                                        {{ csrf_field() }}
                                ...
                                @else
                                    ...
                                    <form method="post" action="{{ url('admin/modelos/'.$modelos->id.'/active')}}">
                                        {{ csrf_field() }}
