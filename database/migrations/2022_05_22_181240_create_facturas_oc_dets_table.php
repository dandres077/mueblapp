...
class CreateFacturasOcDetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('facturas_oc_dets', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('empresa_id')->index()->nullable();
            $table->unsignedBigInteger('producto_id')->index()->nullable();
            $table->unsignedBigInteger('factura_oc_id')->index()->nullable();
            ...
            $table->foreign('factura_oc_id')->references('id')->on('facturas_ocs')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('facturas_oc_dets');
    }
}
