...
class CreateEntregasOcDetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('entregas_oc_dets', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('empresa_id')->index()->nullable();
            $table->unsignedBigInteger('producto_id')->index()->nullable();
            $table->unsignedBigInteger('entrega_oc_id')->index()->nullable();
            ...
            $table->foreign('entrega_oc_id')->references('id')->on('entregas_ocs')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('entregas_oc_dets');
    }
}
