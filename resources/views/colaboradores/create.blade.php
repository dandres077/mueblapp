    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                <a href="{{ url ('admin/colaboradores')}}" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{ url ('admin/colaboradores')}}" class="kt-subheader__breadcrumbs-link">
                {{ $titulo }}</a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                ...
                <div class="kt-portlet__body">
                    <form method="post" class="form-horizontal" action="{{ url('admin/colaboradores/store')}}" autocomplete="off" enctype="multipart/form-data">
                    {{ csrf_field()}}
                        <div class="row">
                            <div class="col-6">
                                    ...
                                    <div class="kt-section__body"> 
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                @foreach ($colaboradores as $tercero)
                                                <option value="{{ $tercero->id }}"> {{ $tercero->opcion }}</option>
                                                @endforeach                                         
                                                </select>
                                            </div>
                                        </div>                                  
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">  
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="redsocial1" name="redsocial1" value="{{ old('redsocial1') }}" required="">
                                            </div>
                                        </div>  
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="redsocial2" name="redsocial2" value="{{ old('redsocial2') }}" required="">
                                            </div>
                                        </div>  
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                            <input type="text" class="form-control" id="redsocial3" name="redsocial3" value="{{ old('redsocial3') }}" required="">
                                            </div>
                                        </div>                                                       
                                        ...
                                        <div class="kt-form__actions">
                                            ...
                                            @endcan
                                            <a href="{{ url ('admin/colaboradores')}}" class="btn btn-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>                                
                            </div>                            
